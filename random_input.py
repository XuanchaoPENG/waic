...
TASK_DESCRIPTIONS_EN: dict[tuple[int, int], str] = {
    ...
    (2, 1): "Use both arms to upright the bottles on both sides.",
    (2, 2): "Use both arms to upright the cans on both sides.",
    (2, 3): "Use both arms to upright the bottles and cans on both sides.",
    (2, 4): "Use both arms to upright the paper cups and cans on both sides.",
