...
LANGUAGE_ZH = "zh"
BUTTON_LABELS = {
    LANGUAGE_EN: {"auto": "Auto", "interact": "Interact", "parallel_env": "Parallel Simulation", "rerun_simulation": "Run Task", "generate": "Generate", "start": "Start", "random_input": "Random Task", "random_scene_input": "Random Scene", "reset": "Reset", "stop": "Stop", "language": "中文"},
    LANGUAGE_ZH: {"auto": "自动", "interact": "交互", "parallel_env": "并行仿真", "rerun_simulation": "运行任务", "generate": "生成", "start": "开始", "random_input": "随机任务", "random_scene_input": "随机场景", "reset": "重置", "stop": "停止", "language": "English"},
}
UI_TEXT = {
    LANGUAGE_EN: {"heading": "# Generative Simulation User Interface", "instruction": "Upload one image, enter one task, then EmbodiChain will generate simulation data what you want.", "robot": "Robot", "input_image": "Input image", "task_description": "Task description", "task_placeholder": "Put the middle bottle on the book", "scene_description": "Scene description", "scene_placeholder": "Optional: describe how to edit the current scene", "scene_mode": "Generation mode", "scene_mode_initial": "Initial generation", "scene_mode_edit": "Edit current scene", "scene_mode_task_only": "Change task only", "single_video_preview": "LeRobot Data Preview", "parallel_video_preview": "Parallel Env Data Preview", "current_task": "Current task", "progress": "Progress", "initial_preview": "Initial scene preview", "edited_preview": "Edited scene preview", "object_preview": "Generated object GLBs preview"},
    LANGUAGE_ZH: {"heading": "# 生成式仿真用户界面", "instruction": "上传一张图片，输入一个任务，EmbodiChain 将生成所需的仿真数据。", "robot": "机器人", "input_image": "输入图像", "task_description": "任务描述", "task_placeholder": "把中间的水瓶放到书上", "scene_description": "场景描述", "scene_placeholder": "可选：描述如何编辑当前场景", "scene_mode": "生成模式", "scene_mode_initial": "初始生成", "scene_mode_edit": "编辑当前场景", "scene_mode_task_only": "仅修改任务", "single_video_preview": "LeRobot 数据预览", "parallel_video_preview": "并行环境数据预览", "current_task": "当前任务", "progress": "进度", "initial_preview": "初始场景预览", "edited_preview": "编辑后场景预览", "object_preview": "生成对象 GLB 预览"},
}
...
PHASE_DEFINITIONS = {
    "idle": (0, "Idle"), "received": (5, "Input received"), "started": (10, "Local pipeline started"), "scene_intake": (20, "Scene understanding"), "relations": (35, "Segmentation and spatial relations"), "asset_generation": (55, "3D asset generation"), "gym_export": (70, "Scene export"), "config": (82, "Action config generated"), "preview": (90, "3D preview loaded"), "complete": (100, "Complete"), "failed": (100, "Failed"),
}
TIMING_PHASE_LABELS = {"relations": "Segmentation / spatial relations", "asset_generation": "Object generation", "gym_export": "Scene generation / export", "action_graph_execution": "Action graph execution"}
TIMING_PHASE_ORDER = ("relations", "asset_generation", "gym_export", "action_graph_execution")
