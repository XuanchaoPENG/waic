...
TASK_DESCRIPTIONS_EN: dict[tuple[int, int], str] = {
    ...
    (2, 1): "Use both arms to set the bottles on both sides upright.",
    (2, 2): "Use both arms to set the cans on both sides upright.",
    (2, 3): "Use both arms to set the bottles and cans on both sides upright.",
    (2, 4): "Use both arms to set the cans on both sides upright.",
...
RELATION_PATTERN = {
    ...
    (2, 3): ["at the left side of the bottle", "at the right side of the can"],
    (2, 4): ["at the left side of the paper cup", "at the right side of the soda can"],
    (3, 0): [],
    (3, 1): [],
    (3, 2): [],
    (3, 3): [],
