...
TASK_DESCRIPTIONS_EN: dict[tuple[int, int], str] = {
    ...
    (2, 0): "Use both arms to place the bananas on both sides onto the tray, then use both arms to lift the tray.",
    ...
    (3, 1): "Stack the objects on the table in this order: right block, left block, paper cup.",
